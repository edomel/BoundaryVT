...
class HighResolutionNet32(nn.Module):
    def __init__(self, norm_layer=None):
        super(HighResolutionNet32, self).__init__()
        ...
        self.stage1_cfg["NUM_BRANCHES"] = 1
...
def _hrnet32(arch, pretrained, progress):
    model = HighResolutionNet32()
    if pretrained:
...
def hrnet32(pretrained=True, progress=True):
    r"""HRNet-32 model"""
    return _hrnet32("hrnet32", pretrained, progress)
